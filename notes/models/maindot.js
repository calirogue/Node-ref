...
// // creating a Schema
// const maindotSchema = new mongoose.Schema({
//     name: {
//         type: String,
//         required: true,
//     },
...
// const Maindot = mongoose.model('Maindot', maindotSchema);

// async function createMaindot() {
//     const maindot = new Maindot({
//         name: 'MainDots',
...
//     const result = await maindot.save();
//     console.log(result);
// }

// createMaindot();

// async function getMaindots() {
//     const maindots = await Maindot
//         .find({ author: 'Matt', isPublished: true })
//         .limit(10)
//         .sort({ name: 1 })
//         .select({ name: 1, tags: 1});
//     console.log(maindots);
// }
